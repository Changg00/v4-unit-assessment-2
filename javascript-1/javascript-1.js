...
// let foundZ = [2[1]];
// let foundZ = nestedLetters[2].list[1];
...
compareNums = (num1,num2) => num1 >= num2 ? num1 : num2;
// let compareNums = (x,y) => {
//     if(x >= y){
//         return x;
//     }
...
//     If (shapes.hasOwnProperty(prop) && shapes[prop] % 2 !== 0) {
//         delete shapes[prop];
//     }
// }
...
//         if (prop==='inPerson') classes[i].prop = false; 
//     }
// }
// for (let i=0; i < classes.length, i++;) {
//     for (let prop in classes[i]) {
//         if (classes[i][prop] === true && typeof(classes[i][prop])==='boolean') {
...
//CODE HERE
let phone1 = new Phone ('nokia', 'n69420', 69, 'hotpink', false)

let phone2 = new Phone ('samsung', 'roids', 1337, 'brown', false)
  
let phone3 = new Phone ('apple', 'zanza', 420, 'red', false)
